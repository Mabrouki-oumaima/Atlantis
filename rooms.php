...
<html lang="en">
  ...
  <?php  
/* Connexion à une base MySQL avec l'invocation de pilote pour recupérer les annonces à partir de la base */
...
$req = "select * from piscine_tab where id between (1,6)";
